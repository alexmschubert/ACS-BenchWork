...
SUPERVISED_MODEL_CKPT_PATH = "/home/ngsci/project/NEJM_benchmark/HuBERT-ECG/finetuned_models" #"/path/to/folder/for/finetuned/models"
        ...
        for ecg, attention_mask, labels in tqdm(train_dl, total=len(train_dl)):
            ...
            if global_step % args.val_interval == 0:
                ...
                if val_loss <= best_val_loss - MINIMAL_IMPROVEMENT: 
                    ...
                    if target_score >= best_val_target_score + MINIMAL_IMPROVEMENT:
                        best_val_target_score = target_score
                        logger.info(f"{args.target_metric} improved as well (= {target_score}). Checkpoint saved at step {global_step}")
