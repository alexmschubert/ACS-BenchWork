...
# Define raw ecg and output directories
input_dir = '/home/ngsci/datasets/ed-bwh-ecg/v1/ecg-waveforms-npz'
output_dir = '/home/ngsci/project/ACS_benchmark/waveforms_3by4/'

# Create output directory if it doesn't exist
os.makedirs(output_dir, exist_ok=True)

# Define the number of samples to take around each R-peak; set to 250 samples, considering sampling rate of 500
samples_around_r_peak = 250 
...
def process_file(file_info):
    ...
    if file.endswith('.npz'):
        ...
        try:
            ...
            # Save the ecg array to the output directory
            filename = file[:-4]
